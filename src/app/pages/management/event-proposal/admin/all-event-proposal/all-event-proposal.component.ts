...
@Component({
  selector: 'ngx-all-event-proposal',
  templateUrl: './all-event-proposal.component.html',
  styleUrls: ['./all-event-proposal.component.scss']
})
export class AllEventProposalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.myEventProposals$ = this.eventProposalService.getAllEventProposals().pipe(map(data => (data as any)?.content));
